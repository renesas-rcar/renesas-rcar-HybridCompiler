HyCo supports https://github.com/onnx/onnx/blob/main/docs/Operators.md#ReduceL2[onnx opset 13], https://pytorch.org/docs/stable/generated/torch.norm.html[torch.norm].
