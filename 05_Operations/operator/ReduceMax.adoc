HyCo supports https://github.com/onnx/onnx/blob/main/docs/Operators.md#ReduceMax[onnx opset 13], https://pytorch.org/docs/stable/generated/torch.max.html[torch.max].
