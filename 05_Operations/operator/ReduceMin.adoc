HyCo supports https://github.com/onnx/onnx/blob/main/docs/Operators.md#ReduceMin[onnx opset 18], https://pytorch.org/docs/stable/generated/torch.min.html[torch.min].
